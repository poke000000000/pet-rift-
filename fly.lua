...
game.Players.LocalPlayer.Character:FindFirstChild("Humanoid"):GetPropertyChangedSignal("MoveDirection"):Connect(function() 
	if getgenv().shouLdFly == true then
        print('should have started flying')
        Fly()
        getgenv().shouLdFly = false
    end
end)
